...
Your `buffet` is ready. Enjoy your delicious tech stack.

## `Starter:`

- [How to become a Hacker?](http://www.catb.org/esr/faqs/hacker-howto.html)

- [Why to learn early?](http://norvig.com/21-days.html)

- [How to ask smart question?](http://www.catb.org/esr/faqs/smart-questions.html)

- [Why blogging important?](https://summertraining.readthedocs.io/en/latest/blogging.html)
...
- **Linux command line**
    ...
    - [LYM](https://lym.readthedocs.io/en/latest/)

- **Agile Development**
    - [Scrum](https://www.tutorialspoint.com/scrum/)
...
- ### Version Control
    ...
    - **Mercurial**
        - [Mercurial](https://www.mercurial-scm.org/wiki/BeginnersGuides)
        - [Vogella](https://www.vogella.com/tutorials/Mercurial/article.html)
...
- ### Markup Languages
    ...
    - **Latex**
        - [Latex](https://www.andy-roberts.net/writing/latex)

    - **reStructuredText**
        - [rst](http://docutils.sourceforge.net/rst.html)

- ### Static Website Generator tool
...
- ### Network Terminology
    ...
    - [Public v Private IP](http://www.differencebetween.info/difference-between-public-ip-and-private-ip-address)
    - [DNS](https://en.wikipedia.org/wiki/Domain_Name_System)
    - [Routers and switches](https://www.diffen.com/difference/Router_vs_Switch)
...
- ### [Interview tips](https://www.geeksforgeeks.org/company-interview-corner/)

- ### Internship
    - [AngelList](https://angel.co/)
    - [Internshala](https://internshala.com/)

- ### [Blogs](https://github.com/fossdelhi/buffet/blob/master/src/blog.md)
